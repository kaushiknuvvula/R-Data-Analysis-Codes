...
tweets <- tweet_corpus("Input your search work here", n = 5000, lang = 'en')


# Save your corpus (because you're limited in how often you can do this for free!)
saveRDS(tweets, file = "C:/Users/Kaushik Nuvvula/Desktop/Fall_2015/EDA/Week_9/abc.Rds", compress = 'xz')

# Okay, read that corpus back in from disk. I'm sure you have a
# different save location, right?
tweets <- readRDS("C:/Users/Kaushik Nuvvula/Desktop/Fall_2015/EDA/Week_9/abc.Rds")
...
corpus <- tm_map(corpus, removeWords, c("linkedin"), mc.cores=1)
...
wordcloud(corpus, min.freq=10, max.words = 200, random.order = TRUE, col = pal )
